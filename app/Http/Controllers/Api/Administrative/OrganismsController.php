    ...
    public function store(Request $request) {
        ...
        # Evalúa cada dato recibido
            ...
            $this->validate($request, [
                ...
                'alias' => 'required',
                'email' => 'required|email|unique:organisms|max:120|unique:employees|unique:associations|unique:partners',
                'web_site' => 'url',
                'zone' => 'required',
                'contact' => 'required',
                'phone' => 'required|numeric',
                'rif' => 'required|alpha_dash|max:12|unique:organisms|unique:employees|unique:associations',
